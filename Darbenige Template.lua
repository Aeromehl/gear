...
--Weapon Sets
	sets.weapons = {}
	sets.weapons.Main = {main="", sub=""}
	sets.weapons.Multi = {main="", sub=""}
	sets.weapons.Eva = {main="", sub=""}	
	
--Ranged Sets
	sets.ranged = {}
	sets.ranged.StatAmmo = {main="", sub=""}	
	sets.ranged.Bow = {main="", sub=""}
	sets.ranged.XBow = {main="", sub=""}
	sets.ranged.Gun = {main="", sub=""}		
