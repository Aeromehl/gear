function init_gear_sets()
	...
	sets.precast.JA['Lunge'] = {head="Chelona Hat +1",neck="Eddy Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
				 body="",hands="", back="Evasionist's Cape",legs="Iuitl Tights",feet="Weatherspoon Souliers +1"}
	sets.precast.JA['Swipe'] = {head="Chelona Hat +1",neck="Eddy Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
				 body="",hands="", back="Evasionist's Cape",legs="Iuitl Tights",feet="Weatherspoon Souliers +1"}
	...
	sets.precast.FC = {ammo="Impatiens",
			head="Runeist Bandeau",neck="Magoraga Beads", ear1="Loquacious Earring",ear2="",
			body="Futhark Coat +1",hands="Shneddick Gloves +1",ring1="",ring2="Veneficium Ring",
			back="Swith Cape",waist="Twilight Belt",legs="Iuitl Tights",feet="Chelona Boots"}
	sets.precast.FC.EnhancingMagic = {ammo="Impatiens",
			head="Runeist Bandeau",neck="", ear1="Loquacious Earring",ear2="Brachyura Earring",
			body="Futhark Coat +1",hands="Shneddick Gloves +1",ring1="",ring2="Veneficium Ring",
			back="Swith Cape",waist="Siegel Sash",legs="Iuitle Tights",feet="Chelona Boots"}
	...
	--MAB
	sets.wsBase['Sanguine Blade'] = {ammo="Aqreqaq Bomblet",
	...
	sets.midcast.EnhancingMagic = {head="",neck="Enhancing Torque",ear1="Loquacious Earring",ear2="Earthcry earring",
					body="Espial Gambison",hands="Shneddick Gloves +1",ring1="Ramuh Ring +1",ring2="Veneficium Ring",
					back="",waist="Siegel sash",legs="Futhark Trousers",feet=""}
	...
	sets.engaged.PDT = {ammo="Vanir Battery",
				...
				body="Futhark Coat +1",hands="Umuthi Gloves",ring1="",ring2="",
